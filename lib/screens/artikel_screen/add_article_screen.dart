...
class _AddArticleScreenState extends State<AddArticleScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      final success = await context.read<ArticleProvider>().createArticle(
      ...
      if (success) {
        _showSuccessSnackBar('Artikel berhasil dibuat');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CustomAppBar(title: 'Buat Artikel', showBackButton: true),
      body: SafeArea(
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Bagikan pengetahuan dan informasi menarik',
                        style: TextStyle(
                          fontSize: 16,
